...
- Crear un PDF nuevo desde imágenes PNG/JPEG o desde texto escrito y archivos `.txt` UTF-8; exportar páginas del PDF abierto como PNG.
...
Los conversores producen documentos o imágenes nuevos de forma local. Imagen a PDF admite PNG/JPEG y texto a PDF admite texto escrito o `.txt` UTF-8; no ofrece OCR ni conversiones de Office. PDF a imagen exporta PNG, no JPEG ni WebP.
